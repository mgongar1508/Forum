    ...
    <div class="flex-1">
        <div class="flex items-center gap-2 text-sm text-gray-400">
            ...
            @if (auth()->check() &&
                ...
                <button wire:click="deleteComment" class="text-red-500 hover:text-red-700 ml-2">
                    <i class="fa-solid fa-trash"></i>
                </button>
            @endif
            @if (auth()->check() && (auth()->user()->hasRole('admin') || auth()->id() === $comment->user_id))
                <button wire:click="startEditComment" class="text-gray-400 hover:text-gray-200 mr-2">
